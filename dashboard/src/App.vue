      ...
      <div class="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3 sm:gap-6">
        <div class="flex shrink-0 items-center gap-2">
          <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground shadow-sm">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" class="h-4.5 w-4.5">
        ...
        <nav class="flex min-w-0 flex-1 gap-1 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <RouterLink
            v-for="item in NAV"
            :key="item.to"
            :to="item.to"
        ...
        <div class="ml-auto flex shrink-0 items-center gap-2 sm:gap-3">
          <Badge :variant="live.conectado ? 'success' : 'destructive'" class="gap-1.5">
            <span
              ...
              :class="live.conectado ? 'bg-primary-foreground animate-pulse' : 'bg-primary-foreground'"
            />
          ...
          >
            <svg v-if="theme.oscuro" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4">
